...
export default function ArchiveHero() {
  ...
  return (
    <header className="mb-12 md:mb-16 max-w-2xl animate-fade-in-up px-2">
      ...
      <h1 className="font-headline-sm md:font-headline-lg text-3xl md:text-headline-lg text-on-surface mb-6 leading-tight">{t('title')}</h1>
