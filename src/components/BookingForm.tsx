...
export default function BookingForm() {
  ...
  return (
    <div className="bg-surface-container-lowest clinical-shadow rounded-xl p-8 md:p-12 animate-fade-in-up">
      {/* Progress Stepper */}
      <div className="flex justify-between items-center mb-12 overflow-x-auto pb-4">
        <div className="flex flex-col items-center gap-2 min-w-[80px]">
          <div className="w-10 h-10 rounded-full bg-secondary text-on-secondary flex items-center justify-center font-bold">1</div>
          <span className="font-label-sm text-label-sm text-secondary">{t('Steps.service')}</span>
        </div>
        <div className="flex-1 h-px bg-outline-variant mx-4 -mt-gutter"></div>
        <div className="flex flex-col items-center gap-2 min-w-[80px]">
          ...
          <span className="font-label-sm text-label-sm text-on-surface-variant">{t('Steps.schedule')}</span>
        </div>
        <div className="flex-1 h-px bg-outline-variant mx-4 -mt-gutter"></div>
        <div className="flex flex-col items-center gap-2 min-w-[80px]">
          ...
          <span className="font-label-sm text-label-sm text-on-surface-variant">{t('Steps.info')}</span>
        </div>
      </div>
      ...
      <form className="space-y-12">
        ...
        <div className="pt-8 border-t border-outline-variant/30 flex justify-end gap-4">
          <button className="px-8 py-3 rounded-full border border-outline text-on-surface font-label-md text-label-md hover:bg-surface-container-high transition-all active:scale-95" type="button">{t('Form.buttons.save')}</button>
          <button className="px-12 py-3 rounded-full bg-primary text-on-primary font-label-md text-label-md clinical-shadow hover:opacity-90 transition-all active:scale-95" type="submit">{t('Form.buttons.confirm')}</button>
        </div>
      </form>
    </div>
  );
