    ...
    <section className="py-16 md:py-24 px-4 md:px-margin-desktop max-w-container-max mx-auto">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 md:gap-16">
        <div className="lg:col-span-5 animate-fade-in-up">
          <h2 className="font-headline-sm md:font-headline-md text-headline-sm md:text-headline-md mb-6 md:mb-8 text-on-surface">{t('name')}</h2>
        ...
        <div className="lg:col-span-7 animate-fade-in-right animation-delay-200">
          <div className="bg-surface-container rounded-2xl p-6 md:p-12">
            <h3 className="font-headline-sm text-headline-sm mb-8 md:mb-10 text-on-surface">{t('journey')}</h3>
            <div className="space-y-8 md:space-y-10 relative">
              ...
              <div className="relative pl-10 rtl:pl-0 rtl:pr-10">
                ...
                <p className="text-on-surface-variant font-body-sm text-body-sm mt-1">{t('step1.description')}</p>
              </div>
              ...
              <div className="relative pl-10 rtl:pl-0 rtl:pr-10">
                ...
                <p className="text-on-surface-variant font-body-sm text-body-sm mt-1">{t('step2.description')}</p>
              </div>
              ...
              <div className="relative pl-10 rtl:pl-0 rtl:pr-10">
                ...
                <p className="text-on-surface-variant font-body-sm text-body-sm mt-1">{t('step3.description')}</p>
              </div>
            </div>
          </div>
        </div>
