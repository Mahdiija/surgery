...
export default function FacilityInnovation() {
  ...
  return (
    <section className="py-24 bg-primary-container text-on-primary-fixed">
      <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-1 md:order-2 space-y-8 animate-fade-in-up">
            <h2 className="font-headline-md text-headline-md text-surface-bright">{t('title')}</h2>
