    ...
    <section className="bg-surface-container-low py-24 px-margin-mobile md:px-margin-desktop">
      <div className="max-w-container-max mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-gutter">
          <div className="bg-surface-container-lowest p-10 rounded-xl clinical-shadow border border-outline-variant/10 animate-fade-in-up">
          ...
          <div className="bg-surface-container-lowest p-10 rounded-xl clinical-shadow border border-outline-variant/10 animate-fade-in-up animation-delay-100">
          ...
          <div className="bg-surface-container-lowest p-10 rounded-xl clinical-shadow border border-outline-variant/10 animate-fade-in-up animation-delay-200">
